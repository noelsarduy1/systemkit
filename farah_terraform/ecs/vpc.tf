...
resource "aws_subnet" "private" {
  ...
  tags = merge (
    {
        Name = "${var.project_name}-${var.platforme_name}-private-subnet"
    }
  )
}
...
resource "aws_subnet" "public" {
  ...
  tags = merge (
    {
        Name = "${var.project_name}-${var.platforme_name}-public-subnet"
    }
  )
}
...
resource "aws_internet_gateway" "test-igw" {
  ...
  tags = merge (
    {
        Name = "${var.project_name}-${var.platforme_name}-igw"
    }
  )
}
...
resource "aws_eip" "test-eip" {
  ...
  tags = merge (
    {
        Name = "${var.project_name}-${var.platforme_name}-eip"
    }
  )
}
...
resource "aws_nat_gateway" "test-natgw" {
  ...
  tags = merge (
    {
        Name = "${var.project_name}-${var.platforme_name}-natg"
    }
  )
}
...
resource "aws_route_table" "private" {
  ...
  tags = merge (
    {
        Name = "${var.project_name}-${var.platforme_name}-route"
    }
  )
}
